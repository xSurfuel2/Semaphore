...
![Salida por consola — cap1.png](./cap1.png)

**Figura 1.** Captura de consola que muestra el comportamiento del sistema:  
- los **tres primeros coches** entran y ocupan las **3 plazas**;  
- los **siguientes** imprimen *“está esperando…”*;  
- cuando un coche **sale**, otro **entra** inmediatamente, manteniendo el máximo de **3** simultáneos.

> Coloca el archivo `cap1.png` en la raíz del repositorio (junto a este README).
